...
const TermsAndConditions = () => {
  ...
  return (
    <Container className="py-3">
      ...
      <p>These terms and conditions outline the rules and regulations for the use of Bread Bank UH's Website, located
        at www.breadbankuh.com.
      </p>

      <p>By accessing this website we assume you accept these terms and conditions. Do not continue to use Bread Bank
        UH if you do not agree to take all of the terms and conditions stated on this page.
      </p>
      ...
      <p>The following terminology applies to these Terms and Conditions, Privacy Statement and Disclaimer Notice and
        ...
        {/* eslint-disable-next-line react/no-unescaped-entities */}
        Company's stated services, in accordance with and subject to, prevailing law of us. Any use of the above
      ...
      {/* eslint-disable-next-line react/no-unescaped-entities */}
      <p>We employ the use of cookies. By accessing Bread Bank UH, you agreed to use cookies in agreement with the
        {/* eslint-disable-next-line react/no-unescaped-entities */}
        Bread Bank UH's Privacy Policy.
      </p>
      ...
      <p>Unless otherwise stated, Bread Bank UH and/or its licensors own the intellectual property rights for all
        material on Bread Bank UH. All intellectual property rights are reserved. You may access this from Bread Bank
        UH for your own personal use subjected to restrictions set in these terms and conditions.
      </p>
      ...
      <p>Parts of this website offer an opportunity for users to post and exchange opinions and information in certain
        areas of the website. Bread Bank UH does not filter, edit, publish or review Comments prior to their presence
        on the website. Comments do not reflect the views and opinions of Bread Bank UH,its agents and/or affiliates.
        Comments reflect the views and opinions of the person who post their views and opinions. To the extent
        permitted by applicable laws, Bread Bank UH shall not be liable for the Comments or for any liability, damages
        or expenses caused and/or suffered as a result of any use of and/or posting of and/or appearance of the
        Comments on this website.
      </p>

      <p>Bread Bank UH reserves the right to monitor all Comments and to remove any Comments which can be considered
      ...
      <p>You hereby grant Bread Bank UH a non-exclusive license to use, reproduce, edit and authorize others to use,
      ...
      <p>We will approve link requests from these organizations if we decide that: (a) the link would not make us look
        ...
        records with us; (c) the benefit to us from the visibility of the hyperlink compensates the absence of Bread
        Bank UH; and (d) the link is in the context of general resource information.
      </p>
      ...
      <p>If you are one of the organizations listed in paragraph 2 above and are interested in linking to our website,
        you must inform us by sending an e-mail to Bread Bank UH. Please include your name, your organization name,
      ...
      {/* eslint-disable-next-line react/no-unescaped-entities */}
      <p>No use of Bread Bank UH's logo or other artwork will be allowed for linking absent a trademark license
        agreement.
      </p>
