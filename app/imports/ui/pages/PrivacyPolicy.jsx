  ...
  return (
    <Container className="py-3">
      ...
      <p>We use Your Personal data to provide and improve the Service. By using the Service, You agree to the
        ...
        with the help of the <a href="https://www.freeprivacypolicy.com/free-privacy-policy-generator/" target="_blank" rel="noreferrer">Free Privacy Policy Generator</a>.
      </p>
      ...
      <ul>
        ...
        <li>
          <p><strong>Company</strong> (referred to as either &quot;the
            Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Bread Bank
            UH, 2500 Campus Rd, Honolulu, HI 96822.
          </p>
        </li>
        <li>
        ...
        <li>
          <p><strong>Country</strong> refers to: Hawaii, United States</p>
        </li>
        <li>
        ...
        <li>
          <p><strong>Website</strong> refers to Bread Bank UH, accessible from <a href="www.breadbankuh.com" rel="external nofollow noopener" target="_blank">www.breadbankuh.com</a>
          </p>
        </li>
        <li>
      ...
      <p>Cookies can be &quot;Persistent&quot; or &quot;Session&quot; Cookies. Persistent Cookies remain on Your
        ...
        Your web browser. Learn more about cookies on the <a href="https://www.freeprivacypolicy.com/blog/sample-privacy-policy-template/#Use_Of_Cookies_And_Tracking" target="_blank" rel="noreferrer">Free Privacy Policy website</a> article.
      </p>
      ...
      <ul>
        <li>
          <p>By email: breadbankuh@email.com</p>
        </li>
        <li>
